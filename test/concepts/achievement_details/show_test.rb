...
module AchievementDetails
  class ShowTest < ActionDispatch::IntegrationTest
    ...
    test 'Show Data' do
      ctx = Operation::Show.call(params: { id: achievement_details(:detail).id }, current_user: @current_user, action: 'DUMMY_ACTION_ID')
      assert_equal achievement_details(:detail).end_at, ctx[:model].end_at
    end
