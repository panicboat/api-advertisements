...
module MeasurementDetails
  class UpdateTest < ActionDispatch::IntegrationTest
    ...
    test 'Update Data More Than Once' do
      ctx1 = Operation::Update.call(params: default_params.merge({ id: measurement_details(:detail2).id, start_at: '2019-07-01 00:00:00', end_at: '2019-08-04 23:59:59' }), current_user: @current_user)
    ...
    test 'Update Duplicate Term' do
      e1 = assert_raises InvalidParameters do
        Operation::Update.call(params: default_params.merge({ id: measurement_details(:detail2).id, start_at: '2019-07-01 00:00:00', end_at: '2019-08-31 23:59:59' }), current_user: @current_user)
      end
      e2 = assert_raises InvalidParameters do
        Operation::Update.call(params: default_params.merge({ id: measurement_details(:detail2).id, start_at: '2019-08-10 00:00:00', end_at: '2019-09-20 23:59:59' }), current_user: @current_user)
      end
      e3 = assert_raises InvalidParameters do
        Operation::Update.call(params: default_params.merge({ id: measurement_details(:detail2).id, start_at: '2019-09-15 00:00:00', end_at: '2019-10-10 23:59:59' }), current_user: @current_user)
      end
      e4 = assert_raises InvalidParameters do
        Operation::Update.call(params: default_params.merge({ id: measurement_details(:detail2).id, start_at: '2019-08-01 00:00:00', end_at: '2019-09-30 23:59:59' }), current_user: @current_user)
      end
